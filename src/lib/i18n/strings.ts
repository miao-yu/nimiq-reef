...
export const STRINGS = {
  en: {
    ...
    signOut: 'Sign out',
    shareYours: 'Share your grove',
    shareThis: 'Share this grove',
    linkCopied: 'Link copied',
    day: 'Day {n}',
    communityGrove: 'The community grove',
    grovesGrowing: '{n} groves growing',
    ...
    whatGrows: '— this is what makes the grove grow',
    validator: 'Validator',
    chooseValidator: 'Choose one',
    loadingValidators: 'Loading the elected set…',
    noPreference: 'Every elected validator, sorted by address. Grove has no preference.',
    ...
    stakeSentNote:
      'It counts from the next watering, within fifteen minutes. Your NIM stays in the staking contract under your own address — Grove only reads it.',
  ...
  de: {
    ...
    signOut: 'Abmelden',
    shareYours: 'Garten teilen',
    shareThis: 'Diesen Garten teilen',
    linkCopied: 'Link kopiert',
    day: 'Tag {n}',
    communityGrove: 'Der Gemeinschaftsgarten',
    grovesGrowing: '{n} Gärten wachsen',
    ...
    whatGrows: '— dadurch wächst der Garten',
    validator: 'Validator',
    chooseValidator: 'Auswählen',
    loadingValidators: 'Lade die gewählten Validatoren…',
    noPreference: 'Alle gewählten Validatoren, nach Adresse sortiert. Grove bevorzugt keinen.',
    ...
    stakeSentNote:
      'Zählt ab dem nächsten Gießen, innerhalb von fünfzehn Minuten. Deine NIM bleiben im Staking-Vertrag unter deiner eigenen Adresse — Grove liest sie nur.',
    chainOffline:
  ...
  es: {
    ...
    shareYours: 'Comparte tu jardín',
    shareThis: 'Compartir este jardín',
    linkCopied: 'Enlace copiado',
    day: 'Día {n}',
    communityGrove: 'El jardín de la comunidad',
    grovesGrowing: '{n} jardines creciendo',
    ...
    whatGrows: '— esto es lo que hace crecer el jardín',
    validator: 'Validador',
    chooseValidator: 'Elige uno',
    loadingValidators: 'Cargando los validadores electos…',
    noPreference: 'Todos los validadores electos, ordenados por dirección. Grove no prefiere ninguno.',
    ...
    stakeSentNote:
      'Cuenta desde el próximo riego, en menos de quince minutos. Tus NIM se quedan en el contrato de staking bajo tu propia dirección — Grove solo los lee.',
    chainOffline:
