...
export const STRINGS = {
  en: {
    ...
    hideReef: 'Hide my reef',
    showReef: 'Show my reef',
  ...
  de: {
    ...
    hideReef: 'Riff verbergen',
    showReef: 'Riff zeigen',
  ...
  es: {
    ...
    viewPublic: 'Página pública',
    hideReef: 'Ocultar mi arrecife',
    showReef: 'Mostrar mi arrecife',
